...
button.addEventListener('click', (event) =>{
    ...
    .then(data => {
        ...
        document.querySelector('.calculation').innerHTML = `BitCoins: ${BitcoinsValue} <br> Currency: ${value} <br> ${value} Rate: ${data.bpi.EUR.rate_float} <br> Value in ${value}: ${equation}`;
        }
        if(value == "USD"){
        ...
        document.querySelector('.calculation').innerHTML = `BitCoins: ${BitcoinsValue} <br> Currency: ${value} <br> ${value} Rate: ${data.bpi.USD.rate_float} <br> Value in ${value}: ${equation}`;
        }
    })
    .catch(error => {
        console.log(error);
